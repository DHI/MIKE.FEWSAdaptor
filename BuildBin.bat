...
if NOT EXIST bin\ModifyMIKESetupFile  MKDIR bin\ModifyMIKESetupFile
...
copy src\ModifyMIKESetupFile\bin\Release\*.*  bin\ModifyMIKESetupFile\
...
del /Q bin\ModifyMIKESetupFile\*.pdb
